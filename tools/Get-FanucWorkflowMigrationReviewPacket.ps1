...
$lines.Add("- Use `TSKSTATUS('F_FLEXI_LOADER',91)` as the proposed single-instance proof before `RUN F_FLEXI_LOADER`, but do not clear this gate until the KAREL helper compiles, uploads, and proves its register contract.")
